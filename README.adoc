...
setup on our legacy Jenkins, but it does manage versions correctly. For this
...
4. Commit your changes to a branch: `git commit -a -m "your message"`
5. Tag your changes with the new version number: `git tag v6.2.342`
6. Push your tagged changes, create a PR and wait for approaval `git push origin my-pr --tags`
